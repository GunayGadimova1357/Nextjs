                ...
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 w-full">
                    <div className="flex justify-around text-center">
                        <div className="flex flex-col">
                            ...
                            <span className="mt-2 text-sm font-semibold text-gray-900 dark:text-white">{formatStat(stats?.public_repos)}</span>
                        </div>
                        <div className="flex flex-col">
                            ...
                            <span className="mt-2 text-sm font-semibold text-gray-900 dark:text-white">{formatStat(stats?.followers)}</span>
                        </div>
                        <div className="flex flex-col">
                            ...
                            <span className="mt-2 text-sm font-semibold text-gray-900 dark:text-white">{formatStat(stats?.following)}</span>
                        </div>
                    </div>
                </div>
            </div>
